...
```javascript
import ndims from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-ndims@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-ndims/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/ndarray-base-ndims/actions/workflows/test.yml?query=branch:v0.2.3
